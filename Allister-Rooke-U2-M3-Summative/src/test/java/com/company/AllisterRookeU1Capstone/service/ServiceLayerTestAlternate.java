...
//@RunWith(MockitoJUnitRunner.class) //Use this or MockAnnotation.initMocks() in setup method,
public class ServiceLayerTestAlternate {
    @Mock
...
//        doReturn(invoice).when(invoiceDao).findInvoice(invoice.getInvoiceId()); unnecessary stubbing
        doReturn(invoice).when(invoiceDao).addInvoice(invoiceNoId);
//        doReturn(invoices).when(invoiceDao).findAllInvoices(); unnecessary stubbing
...
//        salesTaxRateDao = mock(SalesTaxRateDao.class);
    ...
    public void setUp() throws Exception {
        MockitoAnnotations.initMocks(this); //use this in place if @RunWith(Mockito....)
        setUpConsoleDaoMock();
        setUpGameDaoMock();
        setUpInvoiceDaoMock();
        setUpTShirtDaoMock();
